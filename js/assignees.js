...
function pickup_ticket(remove_others) {
    ...
    const user_num = assigneePicker.teams[assigneePicker.teams.length - 1].memberIds.indexOf(user_netid);
    const user_name = assigneePicker.teams[assigneePicker.teams.length - 1].memberRealNames[user_num];
